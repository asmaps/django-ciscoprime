...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrackedRogue'
        db.create_table(u'main_trackedrogue', (
            ...
            ('booth_number', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('exhibitor_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('additional_info', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'main', ['TrackedRogue'])


    def backwards(self, orm):
        # Deleting model 'TrackedRogue'
        db.delete_table(u'main_trackedrogue')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DisabledClient'
        db.create_table(u'main_disabledclient', (
        ...
        db.send_create_signal(u'main', ['DisabledClient'])


    def backwards(self, orm):
        # Deleting model 'DisabledClient'
        db.delete_table(u'main_disabledclient')
